...
// Built off of Gonzales Cenelia code on "https://www.codeproject.com/Articles/36106/Chatbot-Tutorial"
...
int main() {
    ...
    while(1) {
        ...
        if(sInput == "BYE") {
            std::cout << "(imput good bye txt)" << std::endl;  
            break;
        } 
        else if(responses.size() == 0)  {
            std::cout << "Im not sure text." << std::endl;
        }
        else {
